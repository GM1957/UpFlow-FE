                                ...
                                >
                                  {(provided, snapshot) => {
                                    return (
                                      ...
                                      >
                                        {showTaskModal === item.id ? <ShowTaskModal CloseBtn={showTaskModalHandler} Task={item}/> :null}
                                        ...
                                        <p className={classes.AssignedTo}>
                                          Assigned to:{" "}
                                          <span
                                            className={classes.AssignedToEmail}
                                          >
                                            {item.assigneeDetails.email ? item.assigneeDetails.email : "No One"}
                                          </span>
                                        </p>
                                        <div
                                          className={classes.MoreDetailsSection}
                                          onClick={()=> setShowTaskModal(item.id)}
                                        >
                                          more details
                                        </div>
                                      </div>
